...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/benro-redesign/.codex/.gsd-surface.json`
(sibling to `/home/user/benro-redesign/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/benro-redesign/.codex/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/benro-redesign/.codex/skills`).
...
`/home/user/benro-redesign/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/benro-redesign/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/benro-redesign/.codex/.gsd-surface.json`
Install profile marker: `/home/user/benro-redesign/.codex/.gsd-profile`
Skill dirs: `/home/user/benro-redesign/.codex/skills/gsd-*/`
Engine module: `/home/user/benro-redesign/.codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/benro-redesign/.codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
