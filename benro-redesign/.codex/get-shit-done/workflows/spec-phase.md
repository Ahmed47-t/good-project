...
```bash
INIT=$(node "/home/user/benro-redesign/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/user/benro-redesign/.codex/get-shit-done/templates/spec.md.
