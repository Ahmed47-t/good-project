...
- **Global scope**: `/home/user/benro-redesign/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/user/benro-redesign/.codex/notes/`)
...
2. Glob `/home/user/benro-redesign/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/user/benro-redesign/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/user/benro-redesign/.codex/notes/` — works in any directory
