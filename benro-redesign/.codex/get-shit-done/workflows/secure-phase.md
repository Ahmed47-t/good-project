...
```
Agent(
  prompt="Read /home/user/benro-redesign/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/benro-redesign/.codex/get-shit-done/templates/SECURITY.md`
