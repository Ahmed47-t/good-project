...
INSTALL_JS_GLOBAL="/home/user/benro-redesign/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/benro-redesign/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
