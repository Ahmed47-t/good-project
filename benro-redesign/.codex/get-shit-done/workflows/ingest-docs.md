...
```bash
INIT=$(node "/home/user/benro-redesign/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/benro-redesign/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
